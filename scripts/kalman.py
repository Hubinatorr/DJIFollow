...
fig = go.Figure()
fig.add_trace(go.Scatter(x=list(range(len(data))), y=x, mode='lines+markers', name="real X"))
fig.add_trace(go.Scatter(x=list(range(len(data))), y=xZ, mode='lines+markers', name="measurement X"))
fig.add_trace(go.Scatter(x=list(range(len(data))), y=xEst, mode='lines+markers', name="est X"))
fig.show()
